	                ...
	                <div id="remove-scroll">
	                    <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
	                            ...
	                            <div class="user-panel">
	                                <div class="row">
                                        ...
                                        <div class="sidebar-userpic-btn">
									        <a class="tooltips"  id="logout" data-toggle="modal" data-target="#modalLogout" data-placement="top" data-original-title="Logout">
							...
							<li class="nav-item">
	                            ...
	                            <ul class="sub-menu">
	                                <li class="nav-item">
	                                    <a href="./admin/addtaikhoan" class="nav-link ">
	                                        <span class="title">Thêm tài khoản</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="./admin/alltaikhoan" class="nav-link ">
	                                        <span class="title">Xem Danh Sách</span>
	                                    </a>
	                                </li>
