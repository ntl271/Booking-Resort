                            ...
                            <div class="contentTextRoomDetail">
                                <div class="wrapTitleAndPriceRoomDetail">
                                    ...
                                    <div class="wrapPriceRoomDetail">
                                     ...
                                     <?php echo number_format($row1["gia_phong"]) ?> VNĐ</div>
                                    </div>
                                    <div class="wrapPriceRoomDetail">
                                    <?php
        				...
        				<ul class="row listAmenitiesRoomDetail">
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/wf.svg" alt="Wifi miễn phí"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/dt.svg" alt="Điện thoại"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/tv.svg" alt="Tivi"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/maygiat.jpg" alt="máy giặt"></span> 
                                    <h2 class="textTienIchPhong">Máy giặt</h2>
                                </div>
	                        </li>

	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/aochoang.png" alt="ao choang"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/tuqa.png" alt="Tủ quần áo"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/dieuhoa1.jpg" alt="Điều hòa"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/blv.png" alt="Bàn làm việc"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/amnuoc1.jpg" alt="Ấm nước nóng"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/dep.png" alt="Dép"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/maysay1.png" alt="Máy sấy tóc"></span> 
	                        ...
	                        <li class="col-sm-6 col-md-4 col-lg-3 colItemAmenitiesRoomDetail">
                                <div class="contentItemAmenitiesRoomDetail">
                                    <span class="wrapicTienIchPhong"><img src="public/assets/images/kt.png" alt="Áo choàng tắm"></span> 
                                    <h2 class="textTienIchPhong">Khăn tắm</h2>
                                </div>
	                        </li>
        				</ul>
                    </div>
