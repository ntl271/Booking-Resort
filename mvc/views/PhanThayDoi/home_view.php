                ...
                <?php 
                    ...
                    <div class="elementSlideMain">
                        <div class="wrapImgResize wrapImgSlideMain">
                            <img src="public/assets/images/<?php echo $row_ba["image_anh"]?>" alt="trang's resort" />
                        </div>
                       ...
                       <!-- <div class="wrapTextSlideMain">
                            <div class="container-xl containerTextSlideMain">
                                <div class="contentTextSlideMain">
                                    ...
                                    <h2 class="titlePostSlideMain">Trang's resort</h2>
                                </div>
                            </div>
                        </div> -->
                    </div>
                ...
                <div class="contentAboutHome">                    
                    <div class="row rowAboutHome">
                        ...
                        <div class="col-lg-6 colTextAboutHome"> 
                            <h3 class="wrapTitleType1Mini">Chào mừng đến với Resort của Trang</h3>

                            <h3 class="wrapTitleType1 titleMainAboutHome">Tận hưởng trọn vẹn  kì nghỉ của bạn</h3>

                            <div class="wrapTextAboutHome">
                                <p style="font-family: 'IBMPlexSerif'; font-weight: 500; font-size: 18px; line-height: 32px;">Chỉ cách thành phố 5 phút đi xe và nằm trên trung tâm đường Đan Phượng, tự tin đem đến cho bạn những trải nhiệm tuyệt vời nhất trong kì nghỉ dưỡng. Chúng tôi luôn sẵn sàng tiếp đón và phục vụ hết mình vì quý khách.</p>
                                    ...
                                    foreach($danhsach as $row12){
                                        ...
                                        <div class="contentItemProject">
                                            ...
                                            <div class="wrapTextItemProject">
                                                ...
                                                <div class="priceRoomItem">Giá <div class="textPriceRoomItem">'.number_format($row12["gia_phong"]).' VNĐ</div></div>
                                            </div>
                                        </div>
                                    </div>';
                                    }
            ...
            <div class="wrapBgBannerContact">
                <div class="container-xl containerBannerContact">
                    <div class="contentBannerContact">
                        <h3 class="textDescriptionBannerContact">Resort được thiết kế theo phong cách hiện đại và trẻ trung.</h3>
                        ...
                        <div class="wrapSlideTestiomonials">
                            <div class="showSlideTestimonials">
                                <div class="elementlideTestimonials">
                                    <div class="textTestimonial">Chỉ biết nói là quá tuyệt vời để ở với bạn bè hoặc gia đình. Phòng ốc sach đẹp, tiện nghi, bếp ăn khá phong phú không gian thoáng mát gần gủi với môi trường xanh. Ông bà chủ thân thiện, tính tình dễ thương, nói chung là đáng để quay lại.</div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body mediaBodyItemTestimonial">
                                            <div class="titleNameTestimonial">Nguyễn Thị Hoài An</div>

                                            <div class="descriptionTestimonial">Hà Nội</div>
                                ...
                                <div class="elementlideTestimonials">
                                    <div class="textTestimonial">Ta nói rất ưng ý, mới đến đã tạo thiện cảm với khách, rất thích hợp cho những ai mê du lịch nhưng kinh phí phải tiết kiệm. Thật sự rất là tuyệt vời. Chúc resort ngày càng được biết đến và phát triển</div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body mediaBodyItemTestimonial">
                                            <div class="titleNameTestimonial">Nguyễn Văn Hà</div>
