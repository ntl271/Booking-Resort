...
<html lang="vi">
    ...
    <head>
        <meta charset="utf-8" />
        <base href="http://localhost/bookingresort/home_index">
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
        <meta http-equiv="x-ua-compatible" content="ie=edge" />
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <title>Trang chủ | resort</title>

        <link rel="shortcut icon" type="image/x-icon" href="public/assets/images/logo.jpg" />
