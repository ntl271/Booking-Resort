...
class admin extends controler{
    ...
    function addtaikhoan(){
        if(isset($_POST["add_new_taikhoan"])){
        ...
        $result =  $this->doituong->add_taikhoan_model($username,$pass,$email,$sdt,$ten);

        $this->view("admin_index",["page"=>"view_taikhoan",
        "result_tk"=> $result,
        "alltaikhoan"=>$this->doituong->getTaiKhoan(),
        "number_booking"=>$this->doituong->getNumberBookingRoom(),
        "number_lienhe"=>$this->doituong->getNumber_lienhe(),
        "user_info"=>$_SESSION["ten"],
        ...
        $this->view("admin_index",["page"=>"add_taikhoan",
        "number_booking"=>$this->doituong->getNumberBookingRoom(),
        "number_lienhe"=>$this->doituong->getNumber_lienhe(),
        "user_info"=>$_SESSION["ten"],
        "username"=>$_SESSION["username"],
    ...
    function edittaikhoan($username){
        if(isset($_POST["btn_update_taikhoan"])){
            $pass = $_POST["pass"];
            $email = $_POST["email"];
            $sdt = $_POST["sdt"];
            $ten = $_POST["ten"];
        ...
        $result = $this->doituong->update_taikhoan_model($username,$pass,$email,$sdt,$ten);
        ...
        $this->view("admin_index",["page"=>"update_taikhoan",
        "data_taikhoan"=>$this->doituong->getOneTaiKhoan($username),
        "number_booking"=>$this->doituong->getNumberBookingRoom(),
        "number_lienhe"=>$this->doituong->getNumber_lienhe(),
        "user_info"=>$_SESSION["ten"],
        "username"=>$_SESSION["username"],
    ...
    function deletetaikhoan($username){
        $result = $this->doituong->delete_taikhoan($username);
        $this->view("admin_index",["page"=>"view_taikhoan",
        "result_tk"=>$result,
        "alltaikhoan"=>$this->doituong->getTaiKhoan(),
        "number_booking"=>$this->doituong->getNumberBookingRoom(),
